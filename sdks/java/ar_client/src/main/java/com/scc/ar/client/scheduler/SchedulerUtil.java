package com.scc.ar.client.scheduler;
...
public class SchedulerUtil {
	...
	public static synchronized SchedulerUtil build() {
	...
	public <T extends Job> SchedulerUtil addJob(Class<T> jobclass, int interval) {
		try {
